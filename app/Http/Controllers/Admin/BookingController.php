...
class BookingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Bookings/Index', [
            'bookings' => $bookings->through(fn ($b) => [
                ...
                'accompanying_persons' => $b->accompanying_persons,
    ...
    public function show(Booking $booking)
    {
        ...
        return Inertia::render('Admin/Bookings/Show', [
            'booking' => [
                ...
                'consent_accepted' => $booking->consent_accepted,
                'consent_accepted_at' => optional($booking->consent_accepted_at)->toDateTimeString(),
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        return response()->stream(function () use ($bookings) {
            ...
            fputcsv($handle, [
                'Code', 'Institution', 'Category', 'County', 'Constituency', 'Contact Person', 'Email', 'Phone',
                'Date', 'Time Slot', 'Learners', 'Accompanying Persons', 'Total Visitors', 'Disability', 'Nature of Disability', 'Reason', 'Status', 'Created',
            ]);
            ...
            foreach ($bookings as $b) {
                fputcsv($handle, [
                    ...
                    $b->learner_count,
                    $b->accompanying_persons,
                    $b->visitor_count,
                    $b->has_disability ? 'Yes' : 'No',
                    $b->disability_nature,
                    $b->reason_for_visit,
                    $b->status,
